Ext.define('KitchenSink.store.Navigation', {
    ...
    getChartNavItems: function() {
        ...
        if (Ext.isIE8) {
            ...
            items = items.concat(this.addIconClasses([{
                text: 'D3',
                id: 'd3',
                expanded: true,
                description: 'Sencha seamlessly integrates with D3, so you can visualize your stores simply ' +
                    'by binding them to D3 components.',
                children: [
                    {
                        id: 'd3-hierarchy',
                        text: 'Hierarchy',
                        description: 'This set of stock components uses D3\'s hierarchical layouts to render tree stores.',
                        expanded: true,
                        children: [
                    ...
                    },
                    {
                        ...
                        expanded: true,
                        children: [
                            { id: 'd3-view-heatmap-heatmap', text: 'Heatmap', leaf: true },
                    ...
                    },
                    {
                        ...
                        text: 'Custom SVG',
                        expanded: true,
                        description: 'Custom SVG visualizations can be easily created by using the "d3" component directly.',
                        children: [
                            { id: 'd3-view-transitions', text: 'Transitions', leaf: true },
                            { id: 'd3-view-custom-svg-heatmap', text: 'Day / Hour Heatmap', leaf: true }
                        ]
                    },
                    {
                        id: 'd3-canvas',
                        text: 'Custom Canvas',
                        expanded: true,
                        description: 'Custom Canvas visualizations can be easily created by using the "d3-canvas" component directly.',
                        children: [
        ...
        return this.addIconClasses([
            ...
            },
            {
                ...
                children: [
                    ...
                    { id: 'grid-exporter', text: 'Grid Export', leaf: true },
                    ...
                    { id: 'actions-grid', text: 'Reusable Actions', leaf: true },
                    {
                        ...
                        children: [
                            ...
                            {id: 'row-widget-grid', text: 'Row Widgets', leaf: true }
                        ]
                    }
                    // add example above the grid plugins container
                ]
            },
            {
                text: 'Pivot Grids',
            ...
            },
            {
                ...
                id: 'calendar',
                expanded: true,
                description: 'The calendar family of components allows you to manage and visualize ' +
                             'a schedule and keep track of event information.',
                children: [
            ...
            },
            {
                ...
                children: [{
                    ...
                    id: 'drag-drop-grid',
                    expanded: true,
                    description: 'Drag and Drop functionality when interacting with grids',
                    children: [
