...
Ext.define('Ext.ux.window.visualquerybuilder.SQLTableSprite', {
...
Ext.define('Ext.ux.window.visualquerybuilder.SQLTableModel', {
...
Ext.define('Ext.ux.window.visualquerybuilder.SQLTableStore', {
    extend: 'Ext.data.Store',
    autoSync: true,
    model: 'Ext.ux.window.visualquerybuilder.SQLTableModel',
    proxy: {
        type: 'memory'
    }
});

Ext.define('Ext.ux.window.visualquerybuilder.SQLJoin', {
    extend: 'Ext.data.Model',
    fields: [{
        name: 'id',
        type: 'string'
...
Ext.define('Ext.ux.window.visualquerybuilder.JoinStore', {
    extend: 'Ext.data.Store',
    autoSync: true,
    model: 'Ext.ux.window.visualquerybuilder.SQLJoin',
    proxy: {
        type: 'memory'
    }
});

Ext.define('Ext.ux.window.visualquerybuilder.SQLFieldsModel', {
    extend: 'Ext.data.Model',
    fields: [{
        name: 'id',
        type: 'string'
...
Ext.define('Ext.ux.window.visualquerybuilder.SQLFieldsStore', {
    extend: 'Ext.data.Store',
    autoSync: true,
    model: 'Ext.ux.window.visualquerybuilder.SQLFieldsModel',
    proxy: {
        type: 'memory'
    }
});

Ext.define('Ext.ux.window.visualquerybuilder.SQLSelect', {
    config: {
        tables: '',
        fields: '',
        joins: ''
    ...
    constructor: function() {
        ...
        this.tables = Ext.create('Ext.ux.window.visualquerybuilder.SQLTableStore', {
        ...
        this.fields = Ext.create('Ext.ux.window.visualquerybuilder.SQLFieldsStore', {
        ...
        this.joins = Ext.create('Ext.ux.window.visualquerybuilder.JoinStore', {
            storeId: 'JoinStore'
        });
    ...
    getNewField: function() {
        return Ext.create('Ext.ux.window.visualquerybuilder.SQLFieldsModel');
    },
...
Ext.define('Ext.ux.window.visualquerybuilder.SQLTablePanel', {
...
Ext.define('Ext.ux.window.visualquerybuilder.SQLOutputPanel', {
    extend: 'Ext.panel.Panel',
...
Ext.define('Ext.ux.window.visualquerybuilder.SQLFieldsGrid', {
...
Ext.define('Ext.ux.window.visualquerybuilder.SQLTableTree', {
...
Ext.define('Ext.ux.window.visualquerybuilder.SQLTableGrid', {
    extend: 'Ext.grid.Panel',
        ...
        listeners: {
            ...
            drop: function(node, data, dropRec, dropPosition) {
                ...
                if (node.boundView) {
                    ...
                    join = Ext.create('Ext.ux.window.visualquerybuilder.SQLJoin');
                    // set join id
...
Ext.define('Ext.ux.window.visualquerybuilder.SQLTable', {
    ...
    initSQLTable: function() {
        ...
        sprite = Ext.create('Ext.ux.window.visualquerybuilder.SQLTableSprite', {
            type: 'rect',
            stroke: '#fff',
        ...
        console.log(sqlTablePanel.down('draw'));
    ...
    initComponent: function() {
        ...
        tableModel = Ext.create('Ext.ux.window.visualquerybuilder.SQLTableModel', {
            id: this.tableId,
            tableName: this.title,
            tableAlias: ''
        });
...
Ext.define('Ext.ux.window.visualquerybuilder', {
    extend: 'Ext.Panel',
    closeAction: "destroy",
    alias: ['widget.qbpanel'],
    ...
    tbar: [{
        xtype: "combo",
        fieldLabel: "<small><b>Database</b></small>",
        margin: {
            bottom: 4
        },
        labelAlign: "top",
    ...
    initComponent: function() {
        ...
        ux.vqbuilder.sqlSelect = Ext.create('Ext.ux.window.visualquerybuilder.SQLSelect');
