...
Ext.define('Ext.calendar.List', {
    ...
    itemTpl: '<div class="' + '<tpl if="hidden">' + Ext.baseCSSPrefix + 'calendar-list-item-hidden' + '</tpl>">' + '<div class="' + Ext.baseCSSPrefix + 'calendar-list-icon" style="background-color: {color};"></div>' + '<span class="' + Ext.baseCSSPrefix + 'calendar-list-text">{title:htmlEncode}</span>' + '</div>',
...
Ext.define('Ext.calendar.form.CalendarPicker', {
    ...
    getPhonePicker: function() {
        ...
        if (!exists) {
            ...
            slot.setItemTpl('<div class="' + Ext.baseCSSPrefix + 'picker-item {cls}">' + '<div class="' + Ext.baseCSSPrefix + 'calendar-picker-list-icon" style="background-color: {color};"></div>' + '<span>{' + field + ':htmlEncode}</span>' + '</div>');
        }
        return result;
    },
    prepareData: function(data, index, record) {
...
Ext.define('Ext.calendar.view.WeeksRenderer', {
    ...
    calculate: function() {
        var me = this,
            ...
            i, j, dayEvents, event, eLen, utcEnd, end, id, eventEnd, span, offsetStart, offsetEnd, offsetRangeEnd, allDay, item, offset;
        for (i = 0; i < days; ++i) {
    ...
    privates: {
        ...
        doRecalculate: function() {
            ...
            return {
                ...
                activeRange: [
                    visibleRange[0],
                    D.subtract(visibleRange[1], D.DAY, 1)
                ],
...
Ext.define('Ext.overrides.calendar.view.Weeks', {
    ...
    privates: {
        ...
        showOverflowPopup: function(events, date, cell) {
            ...
            tip.show();
            tip.element.alignTo(cell, 'tc-bc?', [
                0,
                -20
            ]);
        }
...
Ext.define('Ext.calendar.panel.AbstractPanel', {
    ...
    destroy: function() {
        var me = this;
        me.sheet = me.sideBar = me.calList = me.mainRegion = me.titleBar = me.calTitle = Ext.destroy(me.sheet);
        me.callParent();
    },
    privates: {
    ...
    privates: {
        ...
        doRecalculate: function() {
            ...
            return me.callParent([
                D.subtract(value, D.DAY, startOffset)
            ]);
        },
        /**
         * @inheritdoc
