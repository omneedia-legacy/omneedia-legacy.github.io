Ext.define('KitchenSink.data.calendar.Month', {
    ...
    var U = KitchenSink.data.calendar.Util,
        ...
        data = {
            work: (function() {
                var f = D.getFirstDateOfMonth(new Date()),
                    firstCurrent = D.utc(f.getFullYear(), f.getMonth(), f.getDate()),
                    l = D.getLastDateOfMonth(f),
                    lastCurrent = D.utc(l.getFullYear(), l.getMonth(), l.getDate()),
                    ret = [],
                    day = 2,
