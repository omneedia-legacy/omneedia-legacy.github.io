            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        text: 'Outline layout',
                        leaf: true,
                        view: 'pivot.LayoutOutline',
                        id: 'pivot-layout-outline'
                    },{
                        text: 'Compact layout',
                        leaf: true,
                        view: 'pivot.LayoutCompact',
                        id: 'pivot-layout-compact'
                    },{
                        text: 'DrillDown plugin',
                        leaf: true,
                        view: 'pivot.DrillDown',
                        id: 'pivot-plugin-drilldown'
                    },{
                        text: 'Configurator plugin',
                        leaf: true,
                        view: 'pivot.Configurator',
                        id: 'pivot-plugin-configurator'
                    },{
                        text: 'RangeEditor plugin',
                        leaf: true,
                        view: 'pivot.RangeEditor',
                        id: 'pivot-plugin-rangeeditor'
                    },{
                        text: 'Exporter plugin',
                        leaf: true,
                        view: 'pivot.ExcelExport',
                        id: 'pivot-plugin-exporter'
                    },{
                        text: 'Row styling',
                        leaf: true,
                        view: 'pivot.RowStyling',
                        id: 'pivot-row-styling'
                    },{
                        text: 'Cell styling',
                        leaf: true,
                        view: 'pivot.CellStyling',
                        id: 'pivot-cell-styling'
                    }]
                }, {
                    text: 'Calendar',
                    leaf: false,
                    ...
                    items: [{
                        ...
                        leaf: true,
                        view: 'calendar.Timezone',
                        id: 'calendar-timezone'
                    }, {
                        text: 'Drag/Resize Validation',
                        leaf: true,
                        view: 'calendar.Validation',
                    ...
                    items: [{
                        ...
                        text: 'Label as PlaceHolder',
                        leaf: true,
                        view: 'LabelAsPlaceHolder',
                        id: 'labelasplaceholder'
                    }]
                }, {
                    text: 'DataViews',
                    leaf: false,
                ...
                items: [{
                    ...
                    text: 'Algebra in Expressions',
                    id: 'Algebra',
                    items: [{
                        text: 'Unary Operators',
                        leaf: true,
                        id: 'binding-algebra-unary',
                        view: 'binding.AlgebraUnary'
                    },{
                        text: 'Binary Operators',
                        leaf: true,
                        id: 'binding-algebra-binary',
                        view: 'binding.AlgebraBinary'
                    },{
                        text: 'Ternary Operators',
                        leaf: true,
                        id: 'binding-algebra-ternary',
                        view: 'binding.AlgebraTernary'
                    },{
                        text: 'Formatters',
                        leaf: true,
                        id: 'binding-algebra-formatters',
                        view: 'binding.AlgebraFormatters'
                    }]
                }]
            }, {
                text: 'Animations',
